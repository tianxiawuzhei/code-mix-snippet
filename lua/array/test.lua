...
asserteq( Array(3, 5), Array.of(5, 5 , 5))
...
asserteq( x:fill(4,1,1), Array(4,2,2,2,3))
...
asserteq( Array(1, 2, 3, 1, 2, 3):lastIndexOf( 3 ), 6 )
asserteq( Array(1, 2, 3, 1, 2, 3):lastIndexOf( 3, -1 ), 6 )
asserteq( Array(1, 2, 3, 1, 2, 3), Array(1, 2, 3, 1, 2, 3))
asserteq( Array(1, 2, 3, 1, 2, 3):lastIndexOf( 2 , -1), 5)
asserteq( Array(1, 2, 3, 1, 2, 3):lastIndexOf( 2, -2 ), 5 )
...
asserteq( Array(1, 2, 3, 4, Array(1, 2, 3, Array(2, 4))), '[1,2,3,4,[1,2,3,[4,4]]]' )
...
asserteq( x, Array(1, 2, 3, 4, 5 ))
asserteq( x:splice(1,0), Array())
asserteq( x, Array(1, 2, 3, 4, 5 ))
asserteq( x:splice(1), Array(1,2,3,4,5))
asserteq( x, Array())
...
x = Array(1, 2, 3, 4, 5)
asserteq( x:splice(1), Array(3,4,5))
asserteq( x, Array(1,2))
x = Array(1, 2, 3, 4, 5)
asserteq( x:splice(2,2), Array(2,3))
asserteq( x, Array(1,4,5))
x = Array(1, 2, 3, 4, 5)
asserteq( x:splice(1,3), Array(1,2,3))
asserteq( x, Array(4,5))
x = Array(1, 2, 3, 4, 5)
...
asserteq( x:splice(2,3, -2,-3,-4), Array(1,2,3))
asserteq( x, Array(0,-2,-3,-4,4,5,6))
asserteq( x:splice(2,4,2,3), Array(-2,-3,-4,4))
asserteq( x, Array(0,2,3,5,6))
asserteq( x:splice(4,0, 4, 5), Array())
asserteq( x, Array(0,2,3,4,5,5,6))
asserteq( x:splice(-4,3, -3), Array(4,5,5))
asserteq( x, Array(0,2,3,-3,6))

asserteq( Array(1, 2, 3, 4, 5):copyWithin( -2 ), Array(1, 2, 3, 1, 2))
asserteq( Array(1, 2, 3, 4, 5):copyWithin( 1, 3), Array(3,4,3,4,5))
asserteq( Array(1, 2, 3, 4, 5):copyWithin( 1, 3, 4), Array(3, 2, 3, 4, 5))
asserteq( Array(1, 2, 3, 4, 5):copyWithin( -2, -3, -1), Array(1, 2, 3, 3, 4))

local x = Array(1, 2, 3, 4, 5)
asserteq( x:slice(), Array())
local x = Array(1, 2, 3, 4, 5)
asserteq( x:slice(1, x.length+1), Array(1, 2, 3, 4, 5))
local x = Array(1, 2, 3, 4, 5)
asserteq( x:slice(1), Array(1, 2, 3, 4, 5))
